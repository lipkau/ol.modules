...
class CImageConverter extends CGUI
{
    ...
    */
    __New(Action)
    {
        ...
        this.btnCopyToClipboard.SetImage(this._copyIcon, 16, 16, 0)
        this.btnConvertAndSave := this.AddControl("Button", "btnConvertAndSave", "x+5 y400 w140", "Convert && &Save && Close")
        this.btnConvertAndSave.SetImage(this._saveIcon, 16, 16, 0)
    ...
    {
        if (TemporaryFiles)
            FileCreateDir, % A_Temp "\7plus\Upload" ;TODO
        ...
        for index, item in this.ListView.Items
        {
            ...
            Target := TemporaryFiles ? A_Temp "\7plus\Upload\" item[1] : ((this.editPath.Text ? this.editPath.Text : (this.TemporaryFiles ? FolderDialog.Folder : SourceDir)) "\" item[2]) ; TODO
    ...
    {
        get {
            return A_ScriptDir "\..\modules\ol.modules\ImageConverter\resources\copy.ico"
        }
    }
    ...
    {
        get {
            return A_ScriptDir "\..\modules\ol.modules\ImageConverter\resources\save.ico"
        }
    }
}
